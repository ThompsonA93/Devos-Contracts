...
!developmentChains.includes(network.name)
    ...
    : describe("# System stress tests on devos system", async function () {
        ...
        it("Deploy: 1x Ballot", async function () {
            ...
            let endEth = await owner.getBalance() / 10 ** 18
        ...
        it("Verify: 1x Voter", async function () {
            ...
            let contractAddress = await DevosVoterArchive
                .connect(owner)
                .requestNationalityData(owner.getAddress());
        ...
        it("Deploy: 10 Archives", async function () {
            const [owner] = await ethers.getSigners()
            const DevosBallotArchiveFactory = await ethers.getContractFactory("Devos_BallotArchive")
        ...
        it("Deploy: 10 Registrars", async function () {
            const [owner] = await ethers.getSigners()
        ...
        it("Deploy: 10 Ballots", async function () {
            const { owner, DevosBallotArchive, DevosVoterArchive } = await loadFixture(deployDevosSystemFixture);
            const DevosBallotFactory = await ethers.getContractFactory("Devos_Ballot")
        ...
        it("Deploy: 100 Archives", async function () {
            const [owner] = await ethers.getSigners()
            const DevosBallotArchiveFactory = await ethers.getContractFactory("Devos_BallotArchive")
        ...
        it("Deploy: 100 Registrars", async function () {
            const [owner] = await ethers.getSigners()
        ...
        it("Deploy: 100 Ballots", async function () {
            const { owner, DevosBallotArchive, DevosVoterArchive } = await loadFixture(deployDevosSystemFixture);
            const DevosBallotFactory = await ethers.getContractFactory("Devos_Ballot")
        ...
        it("Deploy: 1000 Archives", async function () {
            const [owner] = await ethers.getSigners()
            const DevosBallotArchiveFactory = await ethers.getContractFactory("Devos_BallotArchive")
        ...
        it("Deploy: 1000 Registrars", async function () {
            const [owner] = await ethers.getSigners()
        ...
        it("Deploy: 1000 Ballots", async function () {
            const { owner, DevosBallotArchive, DevosVoterArchive } = await loadFixture(deployDevosSystemFixture);
            const DevosBallotFactory = await ethers.getContractFactory("Devos_Ballot")
