...
contract SEMNetRequest is ChainlinkClient, ConfirmedOwner {
    ...
    event RequestVolume(bytes32 indexed requestId, string voter, string volume);
    ...
    function fulfill(
        ...
        emit RequestVolume(_requestId, _nationality, _address);
        nationality = _nationality;
        nationalities[_address] = _nationality;

        // TODO :: Continue voting procedure
